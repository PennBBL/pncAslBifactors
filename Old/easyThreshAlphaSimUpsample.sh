...
clthr=$2 #cluster threshold-- i.e., 3.09, 2.58, 2.33 
clsz=$3 #mimum cluster size (usually from AlphaSim) to look up on easythresh table  #I specified k=97 for equiv probabily of p<0.005 at z>2.58

mask=/data/joy/BBL/projects/pncT1AcrossDisorder_Kaczkurkin/masks/n1895_inc1829_bin_gm_mask.nii.gz
