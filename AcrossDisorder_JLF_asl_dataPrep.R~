...
data.ordered$ACROSS.INCLUDE[data.ordered$pcaslExclude==1] <- 0
...
##After exclusion criteria, there are 1327 subjects
subjData <- data.final
...
saveRDS(subjData,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1325_JLF_asl_subjData.rds")
...
#Save file
saveRDS(AllAnxTdSubjData,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1069_JLF_asl_AllAnxTdSubjData.rds")
...
#Save file
saveRDS(AllAnxSubjData,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n663_JLF_asl_AllAnxSubjData.rds")
...
#Save file
saveRDS(staiSubjData,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1010_JLF_stai_subjData.rds")



###################################################
### ADD ADDITIONAL VOXELWISE EXCLUSION CRITERIA ###
###################################################

##ASL voxelwise data requires its own exclusion criteria variable.
subjData_vox <- subjData
subjData_vox$ACROSS.INCLUDE[subjData_vox$pcaslVoxelwiseExclude==1] <- 0

##Exclude everyone that has this exclusion criteria
subjData_vox <- subjData_vox[which(subjData_vox$ACROSS.INCLUDE == 1), ]

#Save file
saveRDS(subjData_vox,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1274_JLF_aslVox_subjData.rds")
...
#save file
saveRDS(subjData_subset,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1042_JLF_aslVox11andUp_subjData.rds")
...
#save file
saveRDS(subjData_male,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n587_JLF_aslVoxMale_subjData.rds")

#female
subjData_female <- subjData_vox
...
#save file
saveRDS(subjData_female,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n687_JLF_aslVoxFemale_subjData.rds")
...
#save file
saveRDS(subjData_male2,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n468_JLF_aslVox11andUpMale_subjData.rds")
...
#save file
saveRDS(subjData_female2,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n574_JLF_aslVox11andUpFemale_subjData.rds")
...
subjData_sensitivity<-subjData_vox
...
saveRDS(subjData_sensitivity,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1135_JLF_aslVoxSensitivity_subjData.rds")
...
saveRDS(subjData_sensitivity11,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n922_JLF_aslVox11andUpSensitivity_subjData.rds")
...
#n1042 11andUp sample
subjData_conn<-subjData_subset
subjData_conn$ACROSS.INCLUDE.CONN <- 1
subjData_conn$ACROSS.INCLUDE.CONN[subjData_conn$restExcludeVoxelwise==1] <- 0
subjData_conn <- subjData_conn[which(subjData_conn$ACROSS.INCLUDE.CONN == 1), ]

#save file (these are the subjects that pass rest exclusion for connectivity analyses for the n1042 sample)
saveRDS(subjData_conn,"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n833_JLF_connVox11andUp_subjData.rds")
