...
#Subject level data
subjDataName<-"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1042_JLF_aslVox11andUp_subjData_clusters.rds"

#4d merged set of ASL images
tsName<-"/data/joy/BBL/projects/pncAslAcrossDisorder/results/n1042_AslPath/fourd.nii.gz"

#Mask
maskName<-"/data/joy/BBL/projects/pncAslAcrossDisorder/results/n1042_AslPath/mask.nii.gz"
...
subjName<-"/data/joy/BBL/projects/pncAslAcrossDisorder/results/n1042_AslPath/bblids.txt"
...
clsName<-"LM_asl_Fear_LeftSubgenACC"
...
#save data
saveRDS(subjData, "/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1042_JLF_aslVox11andUp_subjData_clusters.rds")
