...
#Subject-level data
rds.name<-"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1042_JLF_aslVox11andUp_subjData_aslPaths.rds"
#rds.name<-"/data/joy/BBL/projects/pncAslAcrossDisorder/subjectData/n1042_JLF_aslVox11andUp_subjData_gmdPaths.rds"
...
#variables<-c( "age","sex","pcaslRelMeanRMSMotion","Bifactor_Mood","Bifactor_Psychosis","Bifactor_Externalizing","Bifactor_Fear","Bifactor_Overall_Psychopathology")
variables<-c( "age","sex","pcaslRelMeanRMSMotion","pcaslMeanGMValue","Bifactor_Mood","Bifactor_Psychosis","Bifactor_Externalizing","Bifactor_Fear","Bifactor_Overall_Psychopathology")
#variables<-c( "age","sex","Bifactor_Mood","Bifactor_Psychosis","Bifactor_Externalizing","Bifactor_Fear","Bifactor_Overall_Psychopathology")

#Define your model
#lin.mod<-"~ age + sex + I(scale(age, scale=FALSE, center=TRUE)^2) + age*sex + I(scale(age, scale=FALSE, center=TRUE)^2)*sex + pcaslRelMeanRMSMotion + Bifactor_Mood + Bifactor_Psychosis + Bifactor_Externalizing + Bifactor_Fear + Bifactor_Overall_Psychopathology"

lin.mod<-"~ age + sex + I(scale(age, scale=FALSE, center=TRUE)^2) + age*sex + I(scale(age, scale=FALSE, center=TRUE)^2)*sex + pcaslRelMeanRMSMotion + pcaslMeanGMValue + Bifactor_Mood + Bifactor_Psychosis + Bifactor_Externalizing + Bifactor_Fear + Bifactor_Overall_Psychopathology"

#lin.mod<-"~ age + sex + I(scale(age, scale=FALSE, center=TRUE)^2) + age*sex + I(scale(age, scale=FALSE, center=TRUE)^2)*sex + Bifactor_Mood + Bifactor_Psychosis + Bifactor_Externalizing + Bifactor_Fear + Bifactor_Overall_Psychopathology"
...
if (modality=="GMD"){
  image.exclude<-"t1Exclude"  #imaging exclusion criteria
  img<-"GmdPath"  #this is the column in the RDS where have list of paths to images-- need to change this to do WM also
