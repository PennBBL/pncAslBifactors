...
#$ -o /cbica/projects/pncNmf/n1396_t1NMF/results/CT_test_new/extractBasesMT.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/projects/pncNmf/n1396_t1NMF/results/CT_test_new/extractBasesMT.$JOB_ID.stderr
####
#### My email address:
#$ -M antoniak@mail.med.upenn.edu
