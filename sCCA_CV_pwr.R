...
#make groups were overall_psychopathology is similar between the groups (can only choose 1 variable to match on, but graphing age, sex, etc. separately shows they are roughly equivalent in such large samples).
#p = what percentage to train on (2/3 = .667)
#list=T makes a list of these 10 partions to pass into other functions
...
# calculate the CV (this is CCA specific and may not apply to non-CCA analyses)
